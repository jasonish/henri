...
use crate::config::{
    ClaudeAuth, ClaudeProviderConfig, ConfigFile, CopilotProviderConfig, ModelConfig,
    OpenAiCompatProviderConfig, OpenAiProviderConfig, OpenRouterConfig, ProviderConfig,
    ProviderType, ZenProviderConfig,
};
...
pub async fn login() -> Result<Option<LoginProvider>> {
    let providers = vec![
        "GitHub Copilot",
        "OpenCode Zen",
        "Claude (Max/Pro)",
...
pub async fn login_opencode_zen() -> Result<()> {
...
pub async fn login_openai_compat() -> Result<()> {
...
pub async fn login_openrouter() -> Result<()> {
...
pub async fn login_openai() -> Result<()> {
